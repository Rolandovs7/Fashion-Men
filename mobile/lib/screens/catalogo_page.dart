  ...
  List<Producto> get _productosFiltrados {
    return productos.where((p) {
      final coincideCategoria =
          categoriaSeleccionada == null || p.categoriaId == categoriaSeleccionada;
      final coincideBusqueda = busqueda.trim().isEmpty ||
                          ...
                          child: ListView(
                            ...
                            children: [
                              _ChipCategoria(
                                ...
                                onTap: () => setState(() => categoriaSeleccionada = null),
                              ),
                              ...categorias.map(
                                (c) => _ChipCategoria(
                                  label: c.nombre,
                                  seleccionado: categoriaSeleccionada == c.id,
                                  onTap: () => setState(() => categoriaSeleccionada = c.id),
                                ),
                              ),
                            ],
                          ),
                                ...
                                delegate: SliverChildBuilderDelegate(
                                  (context, index) {
                                    ...
                                    return _TarjetaProducto(
                                      producto: producto,
                                      categoriaNombre: _nombreCategoria(producto.categoriaId),
                                      onTap: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                            builder: (_) =>
                                                ProductoDetallePage(productoId: producto.id),
                                          ),
                                        );
                                      },
                                    );
          ...
          children: [
            Expanded(
              child: Container(
                ...
                child: const Center(
                  child: Icon(Icons.checkroom, color: Colors.white54, size: 40),
                ),
              ),
            ),
            Padding(
