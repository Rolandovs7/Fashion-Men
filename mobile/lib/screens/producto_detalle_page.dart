  ...
  Future<void> _cargar() async {
    ...
    try {
      ...
      setState(() {
        producto = prod;
        variantes = vars;
        varianteSeleccionada = vars.where((v) => v.stockDisponible > 0).isNotEmpty
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: cargando
          ...
          : producto == null
              ? Center(child: Text(error.isEmpty ? 'Producto no disponible' : error))
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Center(
                          child: Icon(Icons.checkroom, color: Colors.white54, size: 64),
                        ),
                      ),
                              ...
                              child: Opacity(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(12),
                                    border: Border.all(
                                      color: seleccionada ? Colors.black : Colors.grey.shade300,
